...
public class ReportBook implements Iterable<ReportModel>, TableRowModelListener {
     ...
     * key
     *
     * @param key key whose associated ReportReader is to be returned. It is
     ...
     * key
     *
     * @param key key whose associated ReportWriter is to be returned. It is
     *            usually extension of Report file
     * @return ReportWriter
     */
     ...
     * @param key       key whose associated ReportReader is to be returned. it is
     *                  usually extension of Report file
     * @param className ReportReader class name
     */
     ...
     *
     * @param key       ReportWriter key it is usually extension of Report file
     * @param className ReportWriter class name
     */
     ...
     * ReportReader by key
     *
     * @param key ReportReader key it is usually extension of Report file
     ...
     *
     * @param reportModel ReportModel instance
     ...
     *
     * @param index       index at which the reportModel is to be inserted.
     * @param reportModel element instance of the ReportModel to be inserted
     */
     ...
     *
     * @param index the index of the ReportModel to removed.
     ...
     * Removes the ReportModel
     *
     * @param model to be removed from list.
     ...
     *
     * @param index index of ReportModel to return.
     ...
     *
     * @param fromIndex the index of ReportModel to be moved
     * @param toIndex   the new index of the ReportModel
     */
     ...
     *
     * @param index the id of the CellStyle
     ...
     *
     * @param file the file in which the report will be saved
     ...
     *
     * @param file   the file in which the report will be saved
     * @param writer the ReportWriter that is used to save the report
     * @throws IOException IOException
     */
     ...
     *
     * @param file   the report's file
     * @param reader the ReportReader that is used to read the report
     * @throws LoadReportException LoadReportException
     */
     ...
     *
     * @param stream the report's stream
     * @param reader the ReportReader that is used to read the report
     * @throws LoadReportException LoadReportException
     */
     ...
     *
     * @param buf      the bytes' array
     * @param readerId the ReportReader's id
     * @throws LoadReportException LoadReportException
     */
     ...
     *
     * @param value the new report's title
     */
     ...
     *
     * @param creator report's creator
     */
     ...
     *
     * @param date the date of report's creating
     */
     ...
     *
     * @param b true if report view should draw lines
     */
