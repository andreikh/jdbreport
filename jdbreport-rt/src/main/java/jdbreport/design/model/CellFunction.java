...
public interface CellFunction {
     ...
     *
     * @param alias the ReportDataSet alias
     ...
     * @param style    the font's style The style argument is an integer bitmask that
     ...
     *
     * @param color the new background color for the current cell
     */
     ...
     *
     * @param color the new foreground color for the current cell
     */
     ...
     *
     * @param color  the new foreground color for the cell
     * @param row    the cell's row
     * @param column the cell's column
     */
     ...
     *
     * @param height the new row's height
     */
     ...
     *
     * @param width the new column's width
     */
     ...
     *
     * @param align the new horizontal alignment for the current cell
     */
     ...
     * @param index the specified position in this report
     */
     ...
     *
     * @param count count rows
     * @param index the index of the first removing row
     */
     ...
     *
     * @param count count columns
     * @param index the index of the first removing column
     */
     ...
     *
     * @param d the new decimal position of the numeric value.
     */
     ...
     *
     * @param row the row's number
     * @param b   a boolean value, where true sets the page break and false
     *            remove it
     */
     ...
     *
     * @param reportTitle new sheet's title
     */
     ...
     *
     * @param line      the border
     * @param positions boolean values, where true sets border, otherwise does
     ...
     *
     * @param topRow      the top row of the union
     * @param leftColumn  the left column of the union
     * @param bottomRow   the bottom row of the union
     * @param rightColumn the right column of the union
     */
     ...
     *
     * @param stretchPage if true sets printing mode in FIT_WIDTH otherwise in NORMAL
