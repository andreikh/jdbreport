...
public class JdbcSourceEditor extends JDialog {
    ...
    private final TemplateBook reportBook;
    ...
    private JList<JdbcReportSource> sourcesJList = null;
    ...
    private void initSourceList(List<JdbcReportSource> list) {
        ...
        for (JdbcReportSource jdbcDataSets : list) {
            sourceList.add((JdbcReportSource) jdbcDataSets.clone());
        }
    }
    ...
    private void initialize() {
        ...
        this.setTitle(Messages.getString("JdbcSourceEditor.title"));
                ...
                if (isDirty()) {
                    if (JOptionPane
                            .showConfirmDialog(
                                    ...
                                    Messages.getString("JdbcSourceEditor.save_query"),
                                    Messages.getString("JdbcSourceEditor.save_title"),
    ...
    private JButton getOkButton() {
        if (okButton == null) {
            ...
            okButton.setText(Messages.getString("JdbcSourceEditor.ok_text"));
    ...
    private JButton getCancelButton() {
        if (cancelButton == null) {
            ...
            cancelButton.setText(Messages
                    .getString("JdbcSourceEditor.cancel_text"));
    ...
    private JButton getApplyButton() {
        if (applyButton == null) {
            ...
            applyButton.setText(Messages
                    .getString("JdbcSourceEditor.apply_text"));
    ...
    private JPanel getLeftPanel() {
        if (leftPanel == null) {
            ...
            jLabel
                    .setText(Messages
                            .getString("JdbcSourceEditor.label_dataset"));
     ...
     */
    private JList<JdbcReportSource> getSourcesJList() {
    ...
    private JdbcDataSet getCurrentDataSet() {
        if (jTable.getSelectedRow() >= 0) {
            return getQueryModel().getQueryList().get(
    ...
    private JButton getAddButton() {
        if (addButton == null) {
            ...
            addButton.setIcon(ReportResources.getInstance().getIcon("add.gif"));
            addButton.setToolTipText(Messages
                    .getString("JdbcSourceEditor.add_tooltip"));
    ...
    private JButton getDelButton() {
        if (delButton == null) {
            ...
            delButton.setIcon(ReportResources.getInstance().getIcon("del.gif"));
            delButton.setToolTipText(Messages
                    .getString("JdbcSourceEditor.delete_tooltip"));
    ...
    private JButton getAddSourceButton() {
        if (addSourceButton == null) {
            ...
            addSourceButton
                    .addActionListener(e -> addNewSource());
        }
    ...
    private JButton getDelSourceButton() {
        if (delSourceButton == null) {
            ...
            delSourceButton
                    .addActionListener(e -> deleteSource());
            delSourceButton.setToolTipText(Messages
                    .getString("JdbcSourceEditor.deletesource_tooltip"));
    ...
    private JButton getEditSourceButton() {
        if (editSourceButton == null) {
            ...
            editSourceButton.setToolTipText(Messages
                    .getString("JdbcSourceEditor.editsource_tooltip"));
            editSourceButton
                    .addActionListener(e -> showSourceEditor());
        }
    ...
    private JButton getUpButton() {
        if (upButton == null) {
            ...
            upButton.setIcon(ReportResources.getInstance().getIcon("prev.gif"));
