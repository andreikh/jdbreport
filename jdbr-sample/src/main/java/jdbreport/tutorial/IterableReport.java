 ...
 * 
 */
public class IterableReport extends SampleItem {
	...
	final Object[][] data = {
			...
			{ "Katerina", "Koshkina", "violet", "Reservoir Dogs",
					3d, "raspberry" },
			{ "Lev", "Zykin", "purple", "Jules et Jim", 5d,
					"raspberry" },
			...
			{ "Jenifer", "Kim", "blue", "Lone Star", 655321d,
					"strawberry" },
			{ "Ann", "Rues", "turquoise", "The Stuntman", 7d,
					"peach" },
			{ "Justin", "Kennedy", "blue", "Once Upon A Time In The West",
					17d, "pineapple" },
			{ "Avril", "Carry", "orange", "The Music Man", 8d,
					"broccoli" },
			{ "Peter", "Sun", "sunpurple", "Harold & Maude", 12d,
					"sparegrass" },
			{ "Rick", "Lone", "black", "The Fifth Element", 1327d,
					"raspberry" },
			{ "Jeam", "Bullon", "jfcblue", "The Joy Luck Club", 22d,
					"pear" },
			{ "Victoria", "Lohan", "beige", "City of Lost Children",
					9d, "corn" },
			{ "Sasha", "Lamp", "green", "Schindler's List", 3d,
					"strawberry" },
			{ "David", "Candle", "forestgreen", "Withnail & I", 7d,
					"peach" },
			{ "Phillip", "Hengry", "suspectpink", "Das Boot", 3d,
					"banana" },
			{ "Phiona", "Makarova", "cybergreen", "Eraserhead", 52d,
					"peach" },
			{ "Anton", "Muller", "rustred", "Labyrinth", 0d,
					"pineapple" },
					...
					7d, "strawberry" },
			{
					...
					"banana" },
			{ "Vlad", "Kokarev", "aqua", "This is Spinal Tap", 290d,
					"cantaloupe" },
			...
			{ "Katerina", "Bokova", "darkgreen", "Star Wars", 13d,
					"watermelon" },
			{ "Sandy", "Tucker", "eblue", "Aliens", 2d, "broccoli" },
	...
	public static void main(String[] args) {
		IterableReport report = new IterableReport();
		report.run();
	}
