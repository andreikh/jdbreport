 ...
 * 
 */
public class NotRepeatedReport extends SampleItem {
	...
	final Object[][] data = {
			...
			{ "Sasha", "Lamp", "green", "Schindler's List", 3.0,
					"strawberry" },
			{ "David", "Candle", "darkgreen", "Withnail & I", 7.0,
					"peach" },
			{ "Phillip", "Hengry", "gray", "Das Boot", 3.0, "banana" },
			{ "Phiona", "Makarova", "darkgray", "Eraserhead", 52.0,
					"peach" },
			{ "Anton", "Muller", "darkred", "Labyrinth", (double) 0,
					"pineapple" },
	...
	public static void main(String[] args) {
		NotRepeatedReport report = new NotRepeatedReport();
		report.run();
	}

	@Override
	public String getCaption() {
		return "Not repeated cells";
	}

	@Override
	public String getTemplate() {
		return "notrepeate.jdbr";
	}
	...
	public void run() {
		...
		try {
			JDBReport.showReport(getTemplateURL());
