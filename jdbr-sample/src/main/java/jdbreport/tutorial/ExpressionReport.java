...
/**
 * @version 1.0 09.06.2008
 * @author Andrey Kholmanskih
 * 
 */
public class ExpressionReport extends SampleItem {
	...
	public static void main(String[] args) {
		ExpressionReport report = new ExpressionReport();
		report.run();
	}
